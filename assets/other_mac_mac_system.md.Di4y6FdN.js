import{_ as t,C as l,c as p,o as e,j as a,$ as h,G as k,a as i,w as r}from"./chunks/framework.MBq87Dgo.js";const B=JSON.parse('{"title":"Mac常用系统配置","description":"","frontmatter":{},"headers":[],"relativePath":"other/mac/mac_system.md","filePath":"other/mac/mac_system.md","lastUpdated":1748425365000}'),d={name:"other/mac/mac_system.md"},c={id:"mac常用系统配置",tabindex:"-1"};function g(F,s,o,y,C,m){const n=l("center");return e(),p("div",null,[a("h1",c,[k(n,null,{default:r(()=>s[0]||(s[0]=[i("Mac常用系统配置")])),_:1,__:[0]}),s[1]||(s[1]=i()),s[2]||(s[2]=a("a",{class:"header-anchor",href:"#mac常用系统配置","aria-label":'Permalink to "<center>Mac常用系统配置</center>"'},"​",-1))]),s[3]||(s[3]=h(`<h2 id="_1-mac系统任务" tabindex="-1">1. mac系统任务 <a class="header-anchor" href="#_1-mac系统任务" aria-label="Permalink to &quot;1. mac系统任务&quot;">​</a></h2><h3 id="_1-1-创建任务配置" tabindex="-1">1.1 创建任务配置 <a class="header-anchor" href="#_1-1-创建任务配置" aria-label="Permalink to &quot;1.1 创建任务配置&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&lt;?xml version=&quot;1.0&quot; encoding=&quot;UTF-8&quot;?&gt;</span></span>

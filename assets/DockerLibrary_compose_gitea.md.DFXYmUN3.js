import{_ as p,C as e,c as t,o as l,j as a,ae as h,G as r,a as n,w as k}from"./chunks/framework.CBTkueSR.js";const A=JSON.parse('{"title":"Gitea部署","description":"","frontmatter":{},"headers":[],"relativePath":"DockerLibrary/compose/gitea.md","filePath":"DockerLibrary/compose/gitea.md","lastUpdated":1762241207000}'),o={name:"DockerLibrary/compose/gitea.md"},d={id:"gitea部署",tabindex:"-1"};function c(_,s,g,E,y,u){const i=e("center");return l(),t("div",null,[a("h1",d,[r(i,null,{default:k(()=>[...s[0]||(s[0]=[n(" Gitea部署 ",-1)])]),_:1}),s[1]||(s[1]=n()),s[2]||(s[2]=a("a",{class:"header-anchor",href:"#gitea部署","aria-label":'Permalink to "<center> Gitea部署 </center>"'},"​",-1))]),s[3]||(s[3]=h(`<h2 id="_1-compose-安装gitea" tabindex="-1">1 . Compose 安装Gitea <a class="header-anchor" href="#_1-compose-安装gitea" aria-label="Permalink to &quot;1 . Compose 安装Gitea&quot;">​</a></h2><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>services:</span></span>

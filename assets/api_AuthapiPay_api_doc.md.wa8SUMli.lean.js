import{_ as t,C as i,c as e,o as l,j as a,$ as h,G as o,a as n,w as u}from"./chunks/framework.BbOXq0e1.js";const b=JSON.parse('{"title":"Authapi Pay 文档","description":"","frontmatter":{},"headers":[],"relativePath":"api/AuthapiPay/api_doc.md","filePath":"api/AuthapiPay/api_doc.md","lastUpdated":1753970736000}'),r={name:"api/AuthapiPay/api_doc.md"},d={id:"authapi-pay-文档",tabindex:"-1"};function c(k,s,q,g,y,_){const p=i("center");return l(),e("div",null,[a("h1",d,[o(p,null,{default:u(()=>s[0]||(s[0]=[n(" Authapi Pay 文档",-1)])),_:1,__:[0]}),s[1]||(s[1]=n()),s[2]||(s[2]=a("a",{class:"header-anchor",href:"#authapi-pay-文档","aria-label":'Permalink to "<center> Authapi Pay 文档</center>"'},"​",-1))]),s[3]||(s[3]=h(`<h2 id="_1-回调消息" tabindex="-1">1. 回调消息 <a class="header-anchor" href="#_1-回调消息" aria-label="Permalink to &quot;1. 回调消息&quot;">​</a></h2><h3 id="_1-1-充值" tabindex="-1">1.1 充值 <a class="header-anchor" href="#_1-1-充值" aria-label="Permalink to &quot;1.1 充值&quot;">​</a></h3><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>{</span></span>
...
<span class="line"><span># nginx</span></span></code></pre></div>`,9))])}const D=t(r,[["render",c]]);export{b as __pageData,D as default};
